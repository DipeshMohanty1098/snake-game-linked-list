...
const Board = () => {
  ...
  const difficultyArray = [350, 200, 100];
  ...
  useEffect(() => {
    ...
    alert("Hit enter or click OK to start.")
  }, []);
  ...
  const resetGame = key => {
    if (key.key === 'r') {
      alert('Game progress will be lost!')
      handleGameOver();
    }
  }
  ...
  return (
    <>
      ...
      <p>P - Pause, R - Reset, Arrow Keys - Move Snake</p>
      <div style = {{display: "flex"}}>
        <div className = "cell cell-green" style={{height: "20px", width:"20px"}}></div><div style={{paddingLeft:"10px"}}></div> Snake
      </div>
      <div style = {{display: "flex", paddingTop:"10px"}}>
        <div className = "cell cell-red" style={{height: "20px", width:"20px"}}></div><div style={{paddingLeft:"10px"}}></div> Food
      </div>
      <div style = {{display: "flex", paddingTop:"10px", paddingBottom: "10px"}}>
        <div className = "cell cell-purple" style={{height: "20px", width:"20px"}}></div><div style={{paddingLeft:"10px"}}></div> Food with reverse direction
      </div>
      </div>
      <p style={{fontWeight: "bold"}}>Adjust Difficulty (Resets Game)</p>
      <div style = {{display: "flex", paddingTop:"10px", paddingBottom: "10px"}}>
      <div>
        <button onClick={() => { alert("Difficulty changed, resetting game!"); handleGameOver(); setPointer(0)}} checked = {pointer === 0 ? true: false}>Easy</button>
        </div>
        <div style ={{paddingLeft: "10px"}}></div>
        <div>
        <button onClick={() => { alert("Difficulty changed, resetting game!"); handleGameOver();setPointer(1)}}>Medium</button>
        </div>
        <div style ={{paddingRight: "10px"}}></div>
        <div>
        <button onClick={() => { alert("Difficulty changed, resetting game!"); handleGameOver(); setPointer(2)}}>Hard</button>
        </div>
      </div>
      <div className="board">
